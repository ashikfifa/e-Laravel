...
@section('content')
        ...
        <div class="product-detail">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5" id="orders-tab" role="tabpanel"  aria-labelledby="orders-nav">
                        <div class="product-detail-top">
                            <div class="row align-items-center">
                                <div class="col-md-5" id="orders-tab" role="tabpanel" aria-orientation="Horizantal" aria-labelledby="orders-nav">
                                     <h4>Dashboard</h4>
                                ...
                                <div class="col-md-5"aria-orientation="Horizantal" aria-labelledby="orders-nav">
